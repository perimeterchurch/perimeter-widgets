...
interface MultiComboboxBaseProps {
    ...
    isOpen?: boolean;
    /** Called when the dropdown wants to open or close */
...
function MultiCombobox(props: MultiComboboxProps) {
    ...
    const {
        ...
        onIsOpenChange({ isOpen: newIsOpen }) {
            props.onOpenChange?.(newIsOpen ?? false);
        },
    ...
    return (
        ...
        >
            ...
            <div
                className={cn(
                    'flex items-center gap-1 rounded-lg border border-input bg-transparent text-sm transition-colors',
