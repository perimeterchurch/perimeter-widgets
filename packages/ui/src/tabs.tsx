...
const tabsListVariants = cva(
  'group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-fg group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none',
  {
    variants: {
      variant: {
        default: 'bg-muted',
...
function TabsList({
  ...
  return (
    ...
    >
      {children}
      {variant === 'line' && <span data-slot="tabs-indicator" style={indicatorStyle} />}
    </TabsPrimitive.List>
  );
}
