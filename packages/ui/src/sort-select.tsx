        ...
        <div className="absolute right-0 z-50 mt-1 w-48 max-w-[calc(100vw-1rem)] rounded-lg bg-bg shadow-md ring-1 ring-fg/10">
          ...
          <div className="pb-1.5 pt-1">
            <button
              ...
              className="flex w-full items-center gap-2.5 px-3 py-1.5 text-sm transition-colors hover:bg-accent hover:text-accent-fg"
            >
              <ArrowUp className="h-3.5 w-3.5 shrink-0 text-muted-fg" />
              <span className={cn('flex-1 text-left', sortDirection === 'asc' && 'font-medium')}>
                Ascending
              </span>
              {sortDirection === 'asc' && <Check className="h-3.5 w-3.5 shrink-0 text-primary" />}
            </button>
            <button
              type="button"
              onClick={() => {
              ...
              className="flex w-full items-center gap-2.5 px-3 py-1.5 text-sm transition-colors hover:bg-accent hover:text-accent-fg"
            >
              <ArrowDown className="h-3.5 w-3.5 shrink-0 text-muted-fg" />
              <span className={cn('flex-1 text-left', sortDirection === 'desc' && 'font-medium')}>
                Descending
              </span>
              {sortDirection === 'desc' && <Check className="h-3.5 w-3.5 shrink-0 text-primary" />}
            </button>
          </div>
        </div>
      )}
