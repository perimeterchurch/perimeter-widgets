...
import { IMMUTABLE, JS_CONTENT_TYPE, NOT_FOUND_CACHE } from '@/lib/cache';
...
export async function GET(_req: Request, ctx: Ctx): Promise<Response> {
  ...
  if (!stream) return new Response('not found', { status: 404, headers: { 'cache-control': NOT_FOUND_CACHE } });
