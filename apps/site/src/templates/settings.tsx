                        ...
                        <CardContent className='space-y-6'>
                            ...
                            <div className='space-y-2'>
                                ...
                                <Select defaultValue='peachtree-corners'>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value='hamilton-mill'>
                                            Hamilton Mill
                                        </SelectItem>
                                        <SelectItem value='buford'>
                                            Buford
                                        </SelectItem>
                                    </SelectContent>
                                </Select>
                            ...
                            <div className='space-y-2'>
                                ...
                                <p className='text-xs text-muted-foreground'>
                                    This will be visible to small group leaders
                                    and staff.
                                </p>
                            </div>
                        </CardContent>
                        ...
                        <CardContent className='space-y-6'>
                            <div className='flex items-center justify-between'>
                                <div className='space-y-0.5'>
                                    ...
                                    <p className='text-xs text-muted-foreground'>
                                        Get notified before events you
                                        RSVP&apos;d to.
                                    </p>
                                </div>
                            ...
                            <div className='flex items-center justify-between'>
                                <div className='space-y-0.5'>
                                    ...
                                    <p className='text-xs text-muted-foreground'>
                                        Receive messages from your small group
                                        leaders.
                                    </p>
                                </div>
                                <Switch defaultChecked />
                            ...
                            <div className='flex items-center justify-between'>
                                <div className='space-y-0.5'>
                                    ...
                                    <p className='text-xs text-muted-foreground'>
                                        A weekly summary of upcoming events and
                                        news.
                                    </p>
                                </div>
                                <Switch />
