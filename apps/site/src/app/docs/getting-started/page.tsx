        ...
        <article className='max-w-3xl space-y-12'>
            ...
            <header className='space-y-3'>
                ...
                <p className='text-lg text-muted-foreground'>
                    Install Perimeter Church&apos;s shadcn-compatible components
                    directly into your project. You own the source — customize
                    everything.
                </p>
            </header>
            ...
            <section className='space-y-4'>
                ...
                <div className='grid gap-3 sm:grid-cols-3'>
                    {[
                        ...
                        {
                            name: 'shadcn',
                            detail: 'Tailwind CSS v4 + TypeScript',
                        },
                    ].map((item) => (
                        <div
                            key={item.name}
            ...
            <section className='space-y-4'>
                ...
                <p className='text-muted-foreground'>
                    Add individual components with the shadcn CLI. Each
                    component copies its source into your project with all
                    dependencies:
                </p>
                <CodeBlock
                ...
                />
                <p className='text-muted-foreground'>
                    Or install the full base set — all 55 components, tokens,
                    and utilities in one command:
                </p>
                <CodeBlock
                    html={html.addBase}
            ...
            <section className='space-y-4'>
                ...
                <p className='text-muted-foreground'>
                    Import installed components from your project&apos;s
                    component directory. They work like any other React
                    component:
                </p>
                <CodeBlock
                    html={html.usage}
            ...
            <section className='space-y-6'>
                <div className='space-y-2'>
                    ...
                    <p className='text-muted-foreground'>
                        The default palette is a warm stone theme in OKLCH color
                        space. Project-specific themes override selected tokens
                ...
                <div className='space-y-4'>
                    ...
                    <p className='text-muted-foreground'>
                        ...
                        with your overrides. Only specify the tokens you want to
                        change — everything else inherits from the default
                        palette:
                    </p>
                    <CodeBlock
