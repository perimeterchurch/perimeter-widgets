        ...
        <div className='space-y-8'>
            <div>
                ...
                <p className='mt-1 text-muted-foreground'>
                    Project-specific themes override the default token palette.
                    A theme only needs to define tokens that differ from the
                    default.
                </p>
            </div>
            ...
            <section className='space-y-3'>
                ...
                <p className='text-sm text-muted-foreground'>
                    ...
                    . The filename becomes the theme slug. Only include tokens
                    that differ from the default.
                </p>
                <CodeBlock
                    html={themeHtml}
                    rawCode={THEME_EXAMPLE}
                    language='json'
                />
            </section>
