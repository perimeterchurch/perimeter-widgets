...
| `data-default-tab`   | enum    | `series`  | Initial tab: `series` or `sermons`                |
...
| `data-hide-back`     | boolean | _(none)_  | Hide the Back button on a sermon's page — for a sermon-details page (e.g. `/sermons/sermon-details/`) that has its own "Back to All Sermons" link |
...
| ----------------------- | ----------------------- | ------------------------------------------------------------- |
| `id`                    | number                  | The open sermon (always a sermon, on either tab)              |
| `sermons-seriesId`      | number                  | The open series                                               |
