...
const FAQS = [
    {
        ...
        answer: 'We offer two services every Sunday: 9:00 AM and 11:00 AM at all three campus locations. Doors open 15 minutes before each service.',
    },
    {
        question: 'Is there childcare available?',
        answer: 'Yes! We provide safe, fun, and age-appropriate environments for children from birth through 5th grade during every Sunday service. Check-in opens 15 minutes before the service.',
    },
    {
        question: 'How do I join a small group?',
        answer: 'Visit our small groups page to browse available groups by day, time, location, and topic. You can sign up online or ask at the Welcome Center on any Sunday.',
    },
    {
        question: 'What should I expect on my first visit?',
        answer: 'Expect a warm welcome, contemporary worship music, and practical Bible teaching. Dress is casual. Stop by the Welcome Center in the lobby for a free gift and to learn more about getting connected.',
    },
    {
        question: 'How can I start serving?',
        answer: "We'd love to have you on our team! Fill out a volunteer interest form online or visit the Serve desk in the lobby. We have opportunities for every skill set and schedule.",
    },
] as const;
        ...
        <div className='min-h-screen bg-background'>
            ...
            <section className='flex flex-col items-center justify-center gap-6 px-6 py-24 text-center'>
                ...
                <p className='max-w-2xl text-lg text-muted-foreground'>
                    ...
                    looking for a church to call home, we&apos;d love to meet
                ...
                <div className='mx-auto max-w-6xl'>
                    <div className='text-center'>
                        ...
                        <p className='mt-2 text-muted-foreground'>
                            There are many ways to grow and connect at Perimeter
                            Church.
                        </p>
                    </div>
            ...
            <section className='border-t px-6 py-20'>
                <div className='mx-auto max-w-3xl text-center'>
                    ...
                    <p className='mt-3 text-lg text-muted-foreground'>
                        Join thousands of families who call Perimeter Church
                        home. We can&apos;t wait to welcome you.
                    </p>
            ...
            <section className='border-t bg-muted/30 px-6 py-20'>
                <div className='mx-auto max-w-2xl'>
                    <div className='text-center'>
                        ...
                        <p className='mt-2 text-muted-foreground'>
                            Everything you need to know about visiting Perimeter
                            Church.
                        </p>
                    </div>
                    <div className='mt-10'>
