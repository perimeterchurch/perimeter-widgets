    ...
    <div className={cn(fullWidth ? 'w-full' : 'w-auto', className)}>
      <div className={cn('flex items-center gap-1', fullWidth ? 'w-full' : 'w-auto')}>
        <button
          ...
          className={cn(
            'flex h-10 min-w-0 flex-1 items-center gap-2 rounded-lg border bg-[var(--color-bg)] px-3 py-2',
            'text-sm',
  ...
  return (
    ...
    >
      ...
      <input
        ...
        aria-label="Minute"
      />
      <div className="flex h-9 overflow-hidden rounded-md border border-[var(--color-border)] text-xs font-medium">
        <button
          type="button"
