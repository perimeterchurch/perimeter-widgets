        ...
        <div className='flex h-full w-full flex-col items-center justify-center p-4'>
            <div className='flex w-full max-w-[500px] items-center gap-3 rounded-xl bg-stone-100 px-5 py-3 shadow-lg dark:bg-stone-800'>
                ...
                <input
                    ...
                    className='h-1.5 min-w-0 flex-1 cursor-pointer appearance-none rounded-full bg-stone-300 accent-primary dark:bg-stone-600'
                    aria-label='Seek'
                />
                ...
                <div className='flex items-center gap-1.5'>
                    ...
                    <input
                        ...
                        className='h-1 w-16 cursor-pointer appearance-none rounded-full bg-stone-300 accent-primary dark:bg-stone-600'
                        aria-label='Volume'
                    />
                </div>
                <button
                    type='button'
                    onClick={cycleSpeed}
                    className='rounded px-1.5 py-0.5 text-xs font-medium text-stone-500 transition-colors hover:bg-stone-200 hover:text-stone-700 dark:text-stone-400 dark:hover:bg-stone-700 dark:hover:text-stone-200'
